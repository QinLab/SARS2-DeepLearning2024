...
def waterfall(var, as_var, id_var, df_variant, shap_values, base_value, max_display=6, show=False, verbose=False):
    ...
    """
    print (f"Sequence ID: is {id_var}, True variant: {var}, Plot as: {as_var} \n")
    df_col = df_variant
    ...
    directory_path = f"{CONST.RSLT_DIR}/waterfall_plot_miss/{var}"
    if not os.path.exists(directory_path):
        os.makedirs(directory_path)
    
    name = f"{directory_path}/{id_var}_{var}_as_{as_var}_miss.png" 
